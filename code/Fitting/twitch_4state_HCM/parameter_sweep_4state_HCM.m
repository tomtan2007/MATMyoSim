function parameter_sweep_4state_HCM(opt_file)
% Parameter sweep for 4-state HCM model.
...
sgtitle('4-state: peak force and SRX vs parameter', 'FontSize', 13);
saveas(fig, 'temp/sweeps/sweep_4state.png');
fprintf('Saved temp/sweeps/sweep_4state.png\n');
end
