function parameter_sweep_3state_control(opt_file)
...
fig = figure('Name', '3-state control sweep', ...
...
sgtitle('3-state Control: peak force and SRX vs parameter', 'FontSize', 13);
saveas(fig, 'temp/sweeps/sweep_3state_control.png');
fprintf('Saved temp/sweeps/sweep_3state_control.png\n');
end
