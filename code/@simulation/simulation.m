                ...
                for i=1:obj.m.no_of_half_sarcomeres
                    ...
                    if (startsWith(obj.myosim_model.hs_props.kinetic_scheme, ...
                        ...
                        obj.sim_output.M5(t_counter,i) = ...
                            obj.m.hs(i).state_pops.M5;
                        obj.sim_output.M6(t_counter,i) = ...
                            obj.m.hs(i).state_pops.M6;
                        obj.sim_output.M7(t_counter,i) = ...
                            obj.m.hs(i).state_pops.M7;
                        M3_indices = 2+(1:obj.m.hs(i).myofilaments.no_of_x_bins);
                        M4_indices = (2+obj.m.hs(i).myofilaments.no_of_x_bins) + ...
                            (1:obj.m.hs(i).myofilaments.no_of_x_bins);
                        M5_indices = (2+2*obj.m.hs(i).myofilaments.no_of_x_bins) + ...
                            (1:obj.m.hs(i).myofilaments.no_of_x_bins);
                        M6_indices = (2+3*obj.m.hs(i).myofilaments.no_of_x_bins) + ...
                            (1:obj.m.hs(i).myofilaments.no_of_x_bins);
                        obj.sim_output.cb_pops(t_counter,i,1,:) = ...
                            obj.m.hs(i).myofilaments.y(M3_indices);
                        obj.sim_output.cb_pops(t_counter,i,2,:) = ...
                        ...
                        obj.sim_output.cb_pops(t_counter,i,3,:) = ...
                            obj.m.hs(i).myofilaments.y(M5_indices);
                        obj.sim_output.cb_pops(t_counter,i,4,:) = ...
                            obj.m.hs(i).myofilaments.y(M6_indices);
                    end

                    if (startsWith(obj.myosim_model.hs_props.kinetic_scheme, ...
                            '6state_with_SRX_and_titin'))

                        no_x = obj.m.hs(i).myofilaments.no_of_x_bins;
                        obj.sim_output.M1(t_counter,i) = ...
                            obj.m.hs(i).state_pops.M1;
                        obj.sim_output.M2(t_counter,i) = ...
                            obj.m.hs(i).state_pops.M2;
