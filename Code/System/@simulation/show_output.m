    ...
    case '6state_with_SRX_and_titin'
        ...
        for j=1:obj.m.no_of_half_sarcomeres
            ...
            h(4)=plot(obj.sim_output.time_s,obj.sim_output.M4(:,j),'--', ...
                'Color',[0.8 0.2 0.2], ...
                'LineWidth',p.trace_line_width);
            h(5)=plot(obj.sim_output.time_s,obj.sim_output.M5(:,j),'-', ...
                'Color',[0.8 0.2 0.2], ...
                'LineWidth',p.trace_line_width);
            h(6)=plot(obj.sim_output.time_s,obj.sim_output.M6(:,j),':', ...
                'Color',[0.8 0.2 0.2], ...
                'LineWidth',p.trace_line_width);
        end
        legendflex(h,{'M1(SRX)','M2(DRX)','M3(AD)','M4(AT)','M5(DRXT)','M6(SRXT)'}, ...
            'nrow',2, ...
            'anchor',[2 6], ...
            'buffer',[0 10], ...
            'xscale',0.4);
