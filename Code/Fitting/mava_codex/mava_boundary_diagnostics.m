    ...
    switch mode
        ...
        case 'linear'
            ...
            physical_value(i) = parameter.min_value + ...
                p_simulated(i)*(parameter.max_value-parameter.min_value);
            log_distance(i) = normalized_distance(i);
            fold_distance(i) = 1 + normalized_distance(i);
        otherwise
...
D = table(name, p_raw, p_simulated, normalized_distance, log_distance, ...
    fold_distance, lower_bound, upper_bound, physical_value, classification);
end
