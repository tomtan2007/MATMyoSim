function demo_fit_twitch_6state(opt_file)
...
% Honour the optimization file's own output folder -- otherwise a variant
% fit (e.g. optimization_k135.json) overwrites the canonical best model.
